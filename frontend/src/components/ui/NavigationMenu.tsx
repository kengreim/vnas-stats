...
const NavigationMenuTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      class={cn(
        "group/trigger inline-flex h-10 w-full items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[expanded]:bg-accent/50",
        local.class,
      )}
      {...others}
    />
...
const NavigationMenuLink = <T extends ValidComponent = "a">(
  ...
  return (
    <NavigationMenuPrimitive.Item
      class={cn(
        "block space-y-1 rounded-md p-3 leading-none no-underline transition-colors outline-none select-none hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground",
        local.class,
      )}
      {...others}
    />
